...
var phpFiles     = ['./*.php', './**/*.php', '!build/*.php'];
...
gulp.task('browsersync', function() {
  ...
  browserSync.init(files, {
    proxy: "localhost/foxland-themes/checathlon",
...
gulp.task('clean:unneccessary', function() {
	return del(['./build/checathlon/node_modules/**/*', './build/checathlon/build/**/*'])
});
