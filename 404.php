			...
			<section class="error-404 not-found">
				...
				<div class="page-content entry-content">
					<?php
						...
						if ( checathlon_categorized_blog() ) :
					?>

					<div class="widget widget_categories">
						<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'checathlon' ); ?></h2>
						<ul>
						<?php
					...
					<?php
						...
						$archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'checathlon' ), convert_smilies( ':)' ) ) . '</p>';
